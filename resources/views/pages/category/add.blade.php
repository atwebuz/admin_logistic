        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('categoryIndex') }}">Control Category</a></li>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="name_ru"
                                    ...
                                    value="{{ old('name_ru') }}" placeholder="Category Name" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="default_quantity" class="form-control"
                                    value="{{ old('default_quantity') }}" placeholder="Enter a count" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label>Введите Deadline</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-stopwatch"></i></span>
                                </div>
                                <input type="number" name="deadline" class="form-control" value="{{ old('deadline') }}"
                                    placeholder="Напишите в minuteх.Например: 20 && max = 60" max="60" required>
                            </div>
                        </div>
