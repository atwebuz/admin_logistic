        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('driverUpdate',$driver->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="track_num" class="form-control"
                                    value="{{ old('track_num', $driver->track_num) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="eastern_time" class="form-control"
                                    value="{{ old('eastern_time', $driver->eastern_time) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <textarea class="form-control" name="comment" cols="30"
                                    rows="10">{{ old('comment', $driver->comment) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="tag"
                                value="{{old('tag', $driver->tag)}}">
                                <option selected value="{{$driver->tag}}">{{$driver->tag}}</option>
